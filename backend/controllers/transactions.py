...
from schemas.transactions import Transaction, TransactionIn, TransactionOut
...
async def deposit(
    ...
    transaction_out = TransactionOut(account_start=transaction.account_start, amount=transaction.amount, type="deposit")
...
async def withdraw(
    ...
    transaction_out = TransactionOut(account_start=transaction.account_start, amount=transaction.amount, type="withdraw")
...
async def transfer(
    ...
    transaction_out = TransactionOut(account_start=transaction.account_start, amount=transaction.amount, type="transfer")
